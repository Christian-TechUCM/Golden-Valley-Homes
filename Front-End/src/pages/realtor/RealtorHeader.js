...
function RealtorHeader() {
  const { currentUser, logout } = useAuth(); // Assuming currentUserRole is available
        ...
        <Box sx={{ flexGrow: 1, display: "flex", alignItems: "center" }}>
          ...
          {currentUser && (
            <Typography variant="subtitle1" style={{ marginLeft: 10, color: 'black'}}>
              Welcome, Realtor {currentUser.name} {/* Adjust according to your user object */}
            </Typography>
          )}
        </Box>
